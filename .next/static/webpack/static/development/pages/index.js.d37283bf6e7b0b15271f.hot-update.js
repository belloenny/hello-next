...
var HomePage = function HomePage(_ref) {
  ...
  var result = data.data.restaurants;
  console.log(" results are: ".concat(result));
  return __jsx(_components_Layout__WEBPACK_IMPORTED_MODULE_3__["Layout"], {
    ...
    __self: this
  }, result && result.map(function (restaurant) {
    return __jsx("div", {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 29
...
//# sourceMappingURL=index.js.d37283bf6e7b0b15271f.hot-update.js.map